...
public class all_p_f_usid extends AppCompatActivity {

    GloablV gloablV ;
    String S_user_id_login , S_ip;
    private  RecyclerView recy_all_p_f_us_id ;
    private Rec_V_Ad_f_id recyclerView_dAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_p_f_usid);
        ...
        recyclerView_dAdapter = new Rec_V_Ad_f_id(list_p_f_usid, this);
